    ...
    <section className={styles.section} id="about-me">
      <div className={`container ${styles.container}`}>
        ...
        <div className={styles.boxContainer}>
          ...
          >
            I’m a junior full-stack developer looking for a new role in an exciting company. I focus
            on writing accessible HTML, using modern CSS practices and writing clean JavaScript.
            When writing JavaScript code, I mostly use React and TypeScript, but I can adapt to
            whatever tools are required. I’m based in San Salvador, ES, but I’m happy working
            remotely and have experience in remote teams. When I’m not coding, you’ll find me
            studying mathematics, physics and anything computer science related.
          </p>
